...
import (
	...
	"github.com/monteiro-renato/kb-test/internal/controller"
	webhookexamplecomv1alpha1 "github.com/monteiro-renato/kb-test/internal/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "586477c2.my.domain",
